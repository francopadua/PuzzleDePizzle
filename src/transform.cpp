			...
			if (Puzzle::isSolved()) {
				...
				*/
				...
				if (Puzzle::isSolved() && gc.currentScene == Scene::BEGIN_PLAY_SCENE)
					PuzzleResult::resultMsg = getResult(sl.slice);

				Vector2 presultMsg = MeasureTextEx(ga.myFontSmall, PuzzleResult::resultMsg.c_str(), gc.fontScaled, fontSpacing);
				Vector2 ptime = MeasureTextEx(ga.myFontSmall, "Time:", gc.fontScaled, fontSpacing);
				Vector2 pmove = MeasureTextEx(ga.myFontSmall, "Moves:", gc.fontScaled, fontSpacing);
				Vector2 ph1 = MeasureTextEx(ga.myFontSmall, "Hint 1 used:", gc.fontScaled, fontSpacing);
				Vector2 ph2 = MeasureTextEx(ga.myFontSmall, "Hint 2 used:", gc.fontScaled, fontSpacing);	// This is the longest text, maybe because 2 has bigger glyphs than 1

				ImageDrawTextEx(&temp2, ga.myFontSmall, PuzzleResult::resultMsg.c_str(), { (ga.myBgTexture.width / 2.0f) - (presultMsg.x / 2.0f), ga.myBgTexture.height * 0.20f}, gc.fontScaled, fontSpacing, YELLOW);
				ImageDrawTextEx(&temp2, ga.myFontSmall, "Time: ", { (ph2.x - ptime.x) + (ga.myBgTexture.width / 4.0f), ga.myBgTexture.height * 0.30f}, gc.fontScaled, fontSpacing, WHITE);
				ImageDrawTextEx(&temp2, ga.myFontSmall, "Moves: ", { (ph2.x - pmove.x) + (ga.myBgTexture.width / 4.0f), ga.myBgTexture.height * 0.35f}, gc.fontScaled, fontSpacing, WHITE);
				ImageDrawTextEx(&temp2, ga.myFontSmall, "Hint 1 used: ", { (ph2.x - ph1.x) + (ga.myBgTexture.width / 4.0f), ga.myBgTexture.height * 0.40f }, gc.fontScaled, fontSpacing, WHITE);
				ImageDrawTextEx(&temp2, ga.myFontSmall, "Hint 2 used: ", { (ga.myBgTexture.width / 4.0f), ga.myBgTexture.height * 0.45f }, gc.fontScaled, fontSpacing, WHITE);

				ImageDrawTextEx(&temp2, ga.myFontSmall, ga.ptime.c_str(), { (ga.myBgTexture.width / 2.0f), ga.myBgTexture.height * 0.30f }, gc.fontScaled, fontSpacing, WHITE);
				ImageDrawTextEx(&temp2, ga.myFontSmall, ga.pmove.c_str(), { (ga.myBgTexture.width / 2.0f), ga.myBgTexture.height * 0.35f }, gc.fontScaled, fontSpacing, WHITE);
				ImageDrawTextEx(&temp2, ga.myFontSmall, ga.ph1.c_str(), { (ga.myBgTexture.width / 2.0f), ga.myBgTexture.height * 0.40f }, gc.fontScaled, fontSpacing, WHITE);
				ImageDrawTextEx(&temp2, ga.myFontSmall, ga.ph2.c_str(), { (ga.myBgTexture.width / 2.0f), ga.myBgTexture.height * 0.45f }, gc.fontScaled, fontSpacing, WHITE);
			}
		}
